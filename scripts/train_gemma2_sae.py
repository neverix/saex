    ...
    for sparsity_coefficient in sparsity_coefficients:
        config = BufferTrainerConfig(
            ...
            model_config=MicrlhfModelConfig(
                tokenizer_path="NousResearch/gemma-2b-it-tokenizer",
                # gguf_path="weights/gemma-2b.gguf",
                gguf_path="../micrlhf-progress/models/gemma-2-2b-it.gguf",
            ...
            dataset_config=IterableDatasetConfig(
                ...
                dataset_name="nev/gemma-slop-v0",
                clean_fn=lambda x: x.replace("<start_of_turn>assistant", "<start_of_turn>model"),
            ),
            loss_batch_size=16,
